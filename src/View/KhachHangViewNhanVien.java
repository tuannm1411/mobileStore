 ...
 * @author quan l
 */
public class KhachHangViewNhanVien extends javax.swing.JFrame {
...
//        loadSoTrang();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        BanHangView detail1 = new BanHangView();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhachHangViewNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KhachHangViewNhanVien().setVisible(true);
            }
        });
    }
